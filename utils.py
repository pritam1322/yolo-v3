...
def intersection_over_union(self, box_1, box_2, box_format):
    """"
    Arguments:
...
def nms(bboxes, iou_threshold, threshold, box_format = "corners" ):
    ...
    param bboxes:
    param iou_threshold:
    param threshold:threshold if object is present or not
    Return:
...
def mAP(pred_boxes, true_boxes, iou_threshold=0.5, box_format= 'mid_point', num_classes =20 ):
    average_precisions = []
    epsilon = 1e-6
...
def plot_image(image, boxes):
    'Predicted Bounding Box on the image '
